...
import { Play, Pause, AlertTriangle, RefreshCw, TrendingUp, TrendingDown, Activity } from "lucide-react";
...
import { Database, TradeData, MarketData } from '@/lib/types/supabase';
      ...
      <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
        <Card className="p-4">
          <div className="flex flex-col">
            ...
            <span className="text-2xl font-bold">{formatCurrency(metrics.accountValue)}</span>
          ...
          <div className="flex flex-col h-[450px]">
            <div className="flex items-center justify-between pb-6">
              ...
              <div className="flex items-center space-x-2">
                <span className={`text-sm ${(lastTrade.pnl_percent !== null ? lastTrade.pnl_percent : 0) >= 0 ? 'text-green-500' : 'text-red-500'}`}>
                  ROI: {(lastTrade.pnl_percent !== null ? lastTrade.pnl_percent : 0) >= 0 ? '+' : ''}{(lastTrade.pnl_percent !== null ? lastTrade.pnl_percent : 0).toFixed(2)}%
                </span>
              </div>
            </div>
